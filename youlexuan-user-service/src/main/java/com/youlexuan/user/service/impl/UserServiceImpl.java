...
public class UserServiceImpl implements UserService {
    ...
    public void createSmsCode(String phone) {
        ...
        redisTemplate.boundHashOps(CONSTANT.SMSKEY).put(phone,code);
        redisTemplate.boundHashOps(CONSTANT.SMSKEY).expire(5,TimeUnit.MINUTES);
    ...
    public boolean  checkSmsCode(String phone,String code){
        //得到缓存中存储的验证码
        String sysCode = (String) redisTemplate.boundHashOps(CONSTANT.SMSKEY).get(phone);
        if(sysCode==null){
            return false;
        }
